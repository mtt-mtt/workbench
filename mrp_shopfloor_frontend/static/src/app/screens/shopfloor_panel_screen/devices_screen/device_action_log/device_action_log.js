...
import { gatewayCommandFeedback, gatewayCommandSummaryItems, normalizeGatewayCommandEntry, summarizeGatewayCommands } from "../device_command_status";
...
export class ShopfloorDeviceActionLog extends Component {
    ...
    get entries() {
        ...
        return Array.isArray(this.props.recentActions) ? this.props.recentActions : [];
    }
